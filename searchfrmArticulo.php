...
<body>
    ...
    <div class="container mt-5">
        <h1 class="mb-4 text-center">Detalle del Articulo</h1>
            ...
            <div class="card-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="descripcion" value="<?php echo htmlspecialchars($a); ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="estado">Precio</label>
                        <input type="text" class="form-control" id="precio" value="<?php echo htmlspecialchars($b); ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="fechaNacimiento">Stock</label>
                        <input type="text" class="form-control" id="stock" value="<?php echo htmlspecialchars($c); ?>" readonly>
                    </div>
